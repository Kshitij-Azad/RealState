...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="PropertyDeleteServlet">
                <div class="form-group">
                    <label for="propertySelect">Delete Property </label>
                    <center>
                        <% 
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-danger" value="Delete Property" style="width: 20%; margin-left: 40%;">
                </div>
